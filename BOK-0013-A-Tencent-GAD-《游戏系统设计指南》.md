...
前两个条件的达成依靠玩法设计和游戏剧本，和 UI 的关系不大；后一个条件则可以通过 UI 的设计来支撑。
...
**由于游戏本身具备的艺术性和不确定性，游戏测试在关注功能的同时，还需要关注表现性、游戏性和平衡性等内容。**

### 测试的分类

**按照对软件内容实现的了解程度，我们通常将测试分为三类：「白盒测试」、「黑盒测试」和「灰盒测试」。**

### 测试的流程

![](media/14925935324486.jpg)

**在整个游戏的开发过程中，一旦需求确定下来，测试的工作就会和需求的实现同步启动，整个测试的流程可以分为「测试设计」、「测试设计评审」、「测试验收」和「输出测试结果」这四个部分。**
...
设计测试用例的方法有很多种，例如「等价类划分」「边界值」「因果图」「判定表」等。
...
如果你想在游戏策划行业谋得一份职位，那么通过查看各个公司对于策划人才招聘时的需求，就可以看出从事游戏策划这一行业所需要具备的基本技能了。

## 游戏的乐趣和方向

游戏的乐趣主要为：「操作」「战斗」「收集」「交互」「流程」「表现」几个方面，这几个方面囊括了网络游戏玩家进行游戏时的主要游戏感受，把这些内容在游戏制作时进行很好的设计，将会给玩家带来非常多的乐趣。
...
**一款游戏从开始制作到上市有三个跨越难点：首先是「开始做」（游戏立项开始做），其次是「做出来」（能把游戏做出来），最后是「推出去」（能把游戏推入市场）。**
但游戏从制作到能够上市，才达到游戏真正进入市场运作的 1/3 的路程。

以下列出了游戏开发及运营需要重点关注的内容，能够掌握这些内容，将对提高开发效率、游戏品质及在项目管理方面带来很大的帮助。
...
* RPG（Role-Playing Game，角色扮演游戏）：《最终幻想》《仙剑》《剑侠》《暗黑破坏神》《轩辕伏魔录》
* ACT（Action Game，动作游戏）：《超级玛丽》《星之卡比》《波斯王子》
* AVG（Adventure Game，冒险游戏）：《生化危机》《古墓丽影》《恐龙危机》《神秘岛》
* SLG（Strategy Game，策略游戏）：《三国志》《樱花大战》《命令与征服》
* RTS（Real-Time Strategy Game，即时战略游戏）：《魔兽争霸》《帝国时代》《星际争霸》《盟军敢死队》
* FGT（Fighting Game，格斗游戏）：《街霸》《侍魂》《拳皇》《铁拳》《高达格斗》
* STG（Shooting Game，射击类游戏）：《自由空间》《星球大战》《王牌空战》《苏-27》《雷电》《沙罗曼蛇》
* FPS（First Personal Shooting Game，第一人称视角射击游戏）：《DOOM 2》《QUAKE》《虚幻》《半条命》《CS》
* TPS（Third Personal Shooting Game，第三人称视角射击游戏）：《战争机器》《枪神纪》《黑道圣徒》
* PZL（Puzzle Game，益智类游戏）：《俄罗斯方块》
* RCG（Racing Game，竞速游戏，也称作 RAC 的）：《极品飞车》《山脊赛车》《摩托英豪》
* SPT（Sports Game，体育类游戏）：《FIFA》《NBA Live》《实况足球》
* TCG（育成游戏）：《明星志愿》《美少女梦工厂》《零波丽育成计划》
* CAG（Card Game，卡片游戏）：《信长的野望》《游戏王》《武侠 Online》《王国之心》
* TAB（Table Game，桌面游戏）：《大富翁》《拖拉机》《红心大战》《麻将》
* MSC（Music Game，音乐游戏）：《劲乐团》
* LVG（Love Game，恋爱游戏）：《心跳回忆》《思君》《青涩宝贝》《秋忆》
* ETC（其他类游戏）
* H-Game（成人游戏）：《同级生》《龙骑士》《电车之狼》《尾行》《欲望格斗》
* WAG（Wap Game，手机游戏）：《九龙战》《糖果粉碎传奇》《部落冲突》
* MUD（网络泥巴游戏，又称文字聊天室）：《侠客行》《子午线 59》《万王之王》
* MMORPG（Massively Multiplayer Online Role Playing Game，大型多人在线角色扮演游戏）：《网络创世纪》《无尽的任务》《A3》《魔兽》
* ACG（Advanced Casual Game，高级休闲游戏）：《QQ 飞车》《QQ 炫舞》
...
* CB：游戏封测、内测
* OB：游戏公测、开放性测试
* Close Beta：封闭式对外测试，主要测试内容层
* Open Beta：公开测试，商业化模拟试运营
* CCU：同时在线人数
* CPA：按注册成功支付广告费用
* CPC：每次单击的费用，根据广告被单击的次数收费
* CPM：每千次印象费用，为每条广告显示 1000 次印象的费用
* CPS：以实际销售产品数量来计算广告费用
* CTR：广告被单击的次数和广告显示次数的比例
* PPC：Pay-Per-Click
* PPS：Pay-Per-Sale
* DAU：日活跃用户
* MAU：月活跃用户
...
在激烈的市场环境下，怎么做出在市场上真正欢迎的产品，是现在业界各大厂商都在思考的问题。
**其实问题的关键在于定位游戏，也就是把握细分市场的问题。**

我们可以分析哪些需求是玩家们都关注的，把这些需求作为契机，很好地把它们糅合在一起做成一个游戏，充分满足有这部分需求的玩家的喜好，在纷杂的市场环境中就可以占有一席之地。

**未来游戏的主题，一端是休闲、合作、社区化类，另一端是 PK、竞技、对战化类。**
休闲社区的游戏将注重玩家之间的互动，受很多女性玩家及时间不充裕、不喜欢 PK 的玩家喜爱。
PK 竞技类游戏将注重玩家之间的战斗，有很多男性玩家参与，并且受注重操作、喜好团队合作型游戏的玩家喜爱。

除了品类，在行业越来越成熟的网络游戏作为娱乐商品进入市场，在这样「供大于求」的市场环境中，**在商业营销运作中加入包装宣传游戏将是游戏进入市场的一个重要基石**，而画面表现是吸引玩家进入的最直观的因素，具体包含角色、场景、特效、动作和界面，这些将是在玩家眼中脱颖而出的重要手段。

另外是**体验的问题**，现在很多游戏玩法过于公式化，缺乏带入感和毫无娱乐性可言。

还有就是**潮流的导向**，一些前瞻性的策略将成为成功游戏的基础。

每款新产品需要找到自己在市场中的立足点或者与同类相比明显更好的地方（不一样的游戏体验过程），这样才能吸引玩家体验不一样的游戏。
玩家们都喜欢有新意、有变化的内容，而不是一成不变、换汤不换药的内容，这将是开发新游戏时需要好好考虑的问题。
